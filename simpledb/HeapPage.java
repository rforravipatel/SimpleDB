...
public class HeapPage implements Page {
	...
	public Tuple getTuple(int entryID) {
		// some code goes here
		int i = tupleLocation(entryID);                      //getting location of tuple
		if(i != 0)
		{
		...
		return t;                                           //getting tuple if present
		}
		else
		{
			return null;                                     //getting null if not present
		}
	...
	public Iterator<Tuple> iterator() {
		...
		int i = 0;
		while(i < entryCount())                            //loop until the number of entries in the HeapPage
		{
			Tuple t = getTuple(i);
			al.add(t);                                     //adding tuples in iterator
			i++;
		}
		return al.iterator();
		//throw new UnsupportedOperationException("Implement this");
	...
	public void deleteTuple(Tuple t) throws DbException {
		// some code goes here
		saveTupleLocation(t.getRecordId().tupleno(), -1);
		throw new UnsupportedOperationException("Implement this");
	}
	...
	public void addTuple(Tuple t) throws DbException {
		// some code goes here
		byte[] by = toByteArray(t);
		if(freeSpaceSize() < by.length + 4)
		{
			throw new DbException(null);
		}else
		{
			System.arraycopy(by, 0, data, endOfFreeSpace() - by.length, by.length);
		}
		throw new UnsupportedOperationException("Implement this");
	}
	...
	protected int entryCount() {
		// some code goes here
		return readInt(data, 0);                       //number of entries
		//throw new UnsupportedOperationException("Implement this");
	}
